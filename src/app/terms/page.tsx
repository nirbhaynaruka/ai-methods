    ...
    <>
      ...
      <main className="py-20 bg-[#EFEFEF] min-h-[calc(100vh-120px)]">
        <div className="container mx-auto px-6 max-w-4xl">
          <h1 className="text-4xl md:text-5xl font-bold text-[#0A0A0A] mb-8">Terms and Conditions</h1>

          <div className="bg-[#FFFFFF] p-8 rounded-2xl shadow-xl border border-[#E0E0E0] text-[#0A0A0A] max-w-none">
            ...
            <ul>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AI Methods.</li>
              ...
              <li><strong>Website</strong> refers to AI Methods, accessible from <a href="https://aimethods.co" rel="external nofollow noopener" target="_blank">https://aimethods.co</a></li>
            ...
            <ul>
              <li>By email: contact@aimethods.co</li>
            </ul>
          </div>
        </div>
      </main>
